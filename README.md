...
| **AutoHR** | An RAG and Chain of Thought powered AI-HR who can plan and allocate employee's based on the requirement automatically and logically with a solid plan | `Chain of Thought`, `RAG`, `Python` | [GitHub Repo](https://github.com/Rohit909-creator/AutoHR) |
...
| **DreamDoc** | AI system that analyzes and interprets recurring dreams using GPT and a dream dictionary | `GPT`, `RAG`, `Vector Search`, `Prompt Engineering` | [GitHub Repo](https://github.com/Rohit909-creator/DreamDoc) |
